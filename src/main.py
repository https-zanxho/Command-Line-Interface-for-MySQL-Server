...
# TEST THE CONNECTION BETWEEN THE CLI AND THE MYSQL SERVER
try:
...
# FUNCTION TO SEE THE MANUAL
@app.command()
def MANPAGE():
    print("""Man page of the CLI, here are all the commands allowed
...
# FUNCTION CREATING THE FUNCTIONALITY OF THE CLI 
def main_loop():
    while True:
...
# CONDITIONAL TO EXECUTE THE FILE AS MAIN
